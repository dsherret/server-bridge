...
function getGeneratedCode(options) {
    ...
    var importMapping = options.importMapping, _a = options.libraryName, libraryName = _a === void 0 ? "decorator-routes-superagent-client" : _a;
    return get_documentation_1.getDocumentation({ libraryName: libraryName }) +
        get_code_from_classes_1.getCodeFromClasses({ classes: classes, importMapping: importMapping || {}, libraryName: libraryName });
}
